...
public class Driver {
    public static void main(String[] args) {
        ...
        // 1. Creates an array with default values
        ...
        for (int i=0; i< myIntArray1.length;i++){
            System.out.println(myIntArray1[i]); // 0 (primitives cannot be null, only references types can)
        }
        ...
        for (int i=0; i< myIntArray2.length;i++){
            System.out.println(myIntArray2[i]); // 0 (primitives cannot be null, only references types can)
        }
