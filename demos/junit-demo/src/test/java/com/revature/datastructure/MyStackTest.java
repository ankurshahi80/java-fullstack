...
public class MyStackTest {
    ...
    /*
        ...
        example: Popping from an empty stack is something you shouldn't do, but we want to
        see what should actually happen if a user does so.
        In this case, NoSuchElementException should be thrown

        Test cases should follow a AAA pattern.
