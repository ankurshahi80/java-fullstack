...
public class Driver {
    public static void main(String[] args) {
        ...
        byte b = (byte) i; // range of a byte in -128 to 127
        ...
        * */
        ...
        // ex. + <- binary operator
        // It'll automatically convert any primitives smaller than an int to an int
        byte b1 = 100;
        byte b2 = 10;
