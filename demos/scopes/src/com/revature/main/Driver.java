...
public class Driver {
    ...
    public static void main(String[] args) {
        int x = 100; // method scoped variable. x can be accessed inside ANY block within this method
        ...
        /*
            Static v. Non-static
         */
        Person.printNumberOfInstances(); // invoking a static method that exists inside the Person class.
        ...
        for(int i = 0; i < 100000; i++){} // delay the program so that the garbage collector can finish running.
