...
public class Driver {
    public static void main(String[] args) {
        ...
        // by definition have a single abstract method
        ...
        // Java comes with a lot of functional interfaces that exists
        // in the java.util.function package

        // Example of Java's built-in Predicate
        Predicate<String> checkIfStringHasNoCharacters = (String s1) -> {
          return  s1.length() == 0;
        };
